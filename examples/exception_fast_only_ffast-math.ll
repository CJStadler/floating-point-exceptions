; ModuleID = 'examples/exception_fast_only.c'
source_filename = "examples/exception_fast_only.c"
...
define dso_local double @foo(double, double, double) local_unnamed_addr #0 {
  %4 = fadd fast double %2, %1
  %5 = fdiv fast double %4, %0
  ret double %5
}

; Function Attrs: nounwind uwtable
define dso_local i32 @main() local_unnamed_addr #1 {
  %1 = tail call fast double @foo(double 2.000000e+00, double 0x7FDFFFFFFFFFFFFF, double 0x7FE7FFFFFFFFFFFF)
...
attributes #1 = { nounwind uwtable "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "less-precise-fpmad"="false" "min-legal-vector-width"="0" "no-frame-pointer-elim"="false" "no-infs-fp-math"="true" "no-jump-tables"="false" "no-nans-fp-math"="true" "no-signed-zeros-fp-math"="true" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+fxsr,+mmx,+sse,+sse2,+x87" "unsafe-fp-math"="true" "use-soft-float"="false" }
...
!1 = !{!"clang version 8.0.1-svn363027-1~exp1~20190611210016.75 (branches/release_80)"}
