...
int main(){
    ...
    std::cout << "Time difference of Unoptimized = " << std::chrono::duration_cast<std::chrono::microseconds>(end - begin).count() <<std::endl;
    ...
    std::cout << "Time difference of optimized = " << std::chrono::duration_cast<std::chrono::microseconds>(end - begin).count() <<std::endl;
}
